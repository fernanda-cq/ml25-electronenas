        ...
        transforms = torchvision.transforms.Compose(
            [
                *common,
                ...
                # Random horizontal flip - rostros pueden aparecer volteados -- inicio cambios
                torchvision.transforms.RandomHorizontalFlip(p=0.5),
                # Random rotation pequeña - cabezas pueden estar ligeramente inclinadas
                torchvision.transforms.RandomRotation(degrees=15),
                # Random affine - pequeñas transformaciones afines
                torchvision.transforms.RandomAffine(
                    degrees=0,
                    translate=(0.1, 0.1),  # Pequeños desplazamientos
                    scale=(0.9, 1.1),  # Pequeños cambios de escala
                ),
                # Erasing aleatorio - simula oclusiones parciales
